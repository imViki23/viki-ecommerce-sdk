...
-- 1. Insert Brands
INSERT INTO catalog.brands (brand_id, title) VALUES
  ('77f3f0cc-97d3-487d-aae4-c0cafd469d1f', 'Apple'  ),
  ('439e8d63-c99c-49b4-a51c-74c74193370d', 'Samsung');

-- 2. Insert Products
INSERT INTO catalog.products (product_id, brand_id, title, slug) VALUES
...
-- 3. Insert Variants
INSERT INTO catalog.variants (variant_id, product_id, sku, attributes) VALUES
